...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final LifcycleLibraryAccessors laccForLifcycleLibraryAccessors = new LifcycleLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>lifcycle</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public LifcycleLibraryAccessors getLifcycle() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForLifcycleLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class LifcycleLibraryAccessors extends SubDependencyFactory {
        private final LifcycleRuntimeLibraryAccessors laccForLifcycleRuntimeLibraryAccessors = new LifcycleRuntimeLibraryAccessors(owner);

        public LifcycleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>lifcycle.runtime</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public LifcycleRuntimeLibraryAccessors getRuntime() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForLifcycleRuntimeLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class LifcycleRuntimeLibraryAccessors extends SubDependencyFactory {

        public LifcycleRuntimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("lifcycle.runtime.compose");
        }
